    ...
    render() {
        ...
        return(
            <div className={"logWrapper"}>
                <div className={"mobileLogo d-none d-lg-flex "} onMouseOver={()=> this.changeActiveMenu( true)} onMouseOut={() => this.changeActiveMenu(false)}>
...
<div className={"log d-block d-md-none"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="20" viewBox="0 0 20 20"><path fill="#333" d="M17 13.9l-5.4-3a4.4 4.4 0 0 1-5.2 0l-5.3 2.8c-.7.3-1.1.9-1.1 1.5v1.7c0 .6.5 1 1.1 1h15.8c.6 0 1-.4 1-1v-1.7c0-.6-.3-1.1-.8-1.3M13.6 5.3c0 3-2 5.3-4.6 5.3-2.6 0-4.6-2.4-4.6-5.3 0-3 2-5.3 4.6-5.3 2.6 0 4.6 2.4 4.6 5.3"></path></svg>
            </div>
                <div className={"log d-none d-md-block"}>
                    <a href="">Log In</a>
                </div>
                <div className={"sign d-none d-md-block"}>
                    <a href="">Sign Up</a>
                </div>
