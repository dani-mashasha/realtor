...
class Gallery extends React.Component{
    ...
    updateGallery =(data)=>{
        ...
        if(min){
            apartmentList = apartmentList.filter(item =>{return item.price > min} );
        }
        if(max){
            apartmentList = apartmentList.filter(item =>{return  item.price < max} );
        }
        if(beds){
            apartmentList = apartmentList.filter(item =>{return item.number_of_beds == beds} );
        }
        if(baths){
            apartmentList = apartmentList.filter(item =>{return item.number_of_rooms == baths} );
        }
        if(city){
